...
// Paginated brand history feed (for Brands & Companies Report)
router.get(
    '/history',
    auth,
    requireAnyModulePermission(['brands_page', 'brands_companies_report', 'task_brand_assignment', 'create_task', 'assign_task']),
    brandController.getBrandHistoryFeed
);
