...
const ensureDefaultRoles = async () => {
    const defaults = [
        { moduleId: 'tasks_page', name: 'All Tasks', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'allow', manager: 'allow', troubleshoot_manager: 'allow', sbm: 'allow', assistant: 'allow', sub_assistance: 'allow', sales_manager: 'allow', sales_man: 'allow', software_developer: 'allow', soft_ware_deloper: 'allow' } },
        { moduleId: 'calendar_page', name: 'Calendar', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'allow', manager: 'allow', troubleshoot_manager: 'allow', assistant: 'allow', sub_assistance: 'allow', sales_manager: 'allow', sales_man: 'allow', software_developer: 'allow', soft_ware_deloper: 'allow' } },
        ...
        { moduleId: 'brand_delete', name: 'Brand Delete', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'deny', manager: 'deny', assistant: 'deny', sub_assistance: 'deny', sales_manager: 'deny', sales_man: 'deny' } },
        ...
        { moduleId: 'create_task', name: 'Create Task', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'allow', manager: 'allow', troubleshoot_manager: 'allow', sbm: 'allow', rm: 'allow', am: 'allow', ar: 'allow', assistant: 'deny', sub_assistance: 'deny', sales_manager: 'allow', sales_man: 'allow', software_developer: 'allow', soft_ware_deloper: 'allow' } },
        { moduleId: 'assign_task', name: 'Assign Task', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'allow', manager: 'allow', troubleshoot_manager: 'allow', sbm: 'allow', rm: 'allow', am: 'allow', ar: 'allow', assistant: 'deny', sub_assistance: 'deny', sales_manager: 'deny', sales_man: 'deny', software_developer: 'allow', soft_ware_deloper: 'allow' } },
        ...
        { moduleId: 'edit_any_task', name: 'Edit Any Task', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'team', manager: 'own', rm: 'allow', am: 'allow', assistant: 'deny', sub_assistance: 'deny', sales_manager: 'deny', sales_man: 'deny' } },
        { moduleId: 'delete_task', name: 'Delete Task', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'deny', manager: 'deny', assistant: 'deny', sub_assistance: 'deny', sales_manager: 'deny', sales_man: 'deny' } },
        { moduleId: 'view_all_tasks', name: 'View All Tasks', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'allow', manager: 'allow', troubleshoot_manager: 'allow', sbm: 'allow', rm: 'allow', am: 'allow', ar: 'allow', assistant: 'deny', sub_assistance: 'deny', sales_manager: 'deny', sales_man: 'deny', software_developer: 'allow', soft_ware_deloper: 'allow' } },
        { moduleId: 'view_assigned_tasks', name: 'View Assigned Tasks', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'allow', manager: 'allow', troubleshoot_manager: 'allow', assistant: 'allow', sub_assistance: 'allow', sales_manager: 'deny', sales_man: 'deny', software_developer: 'allow', soft_ware_deloper: 'allow' } },
        ...
        { moduleId: 'reports_analytics', name: 'Reports / Analytics', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'deny', manager: 'team', assistant: 'deny', sub_assistance: 'deny', sales_manager: 'deny', sales_man: 'deny' } },
        { moduleId: 'access_management', name: 'Access Management', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'deny', manager: 'deny', assistant: 'deny', sub_assistance: 'deny', sales_manager: 'deny', sales_man: 'deny' } },
        ...
        { moduleId: 'personal_tasks_page', name: 'Personal Tasks Page', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'allow', manager: 'allow', troubleshoot_manager: 'allow', sbm: 'allow', rm: 'allow', am: 'allow', ar: 'allow', assistant: 'allow', sub_assistance: 'deny', sales_manager: 'allow', sales_man: 'allow', software_developer: 'allow', soft_ware_deloper: 'allow' } },
    ];
...
const ensureDefaultModules = async () => {
    ...
    const defaults = [
        { moduleId: 'tasks_page', name: 'All Tasks', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'allow', manager: 'allow', sbm: 'allow', assistant: 'allow', sub_assistance: 'allow', sales_manager: 'allow', sales_man: 'allow', software_developer: 'allow', soft_ware_deloper: 'allow' } },
        { moduleId: 'calendar_page', name: 'Calendar', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'allow', manager: 'allow', assistant: 'allow', sub_assistance: 'allow', sales_manager: 'allow', sales_man: 'allow', software_developer: 'allow', soft_ware_deloper: 'allow' } },
        { moduleId: 'reviews_page', name: 'Reviews', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'deny', ob_manager: 'allow', manager: 'deny', assistant: 'deny', sub_assistance: 'deny', sales_manager: 'deny', sales_man: 'deny' } },
        { moduleId: 'other_work_page', name: 'Other Work', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'deny', manager: 'allow', assistant: 'deny', sub_assistance: 'deny', sales_manager: 'deny', sales_man: 'deny' } },
        { moduleId: 'user_management', name: 'User Management', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'allow', manager: 'deny', sbm: 'allow', rm: 'allow', am: 'allow', assistant: 'deny', sub_assistance: 'deny', sales_manager: 'deny', sales_man: 'deny' } },
        ...
        { moduleId: 'brand_bulk_add', name: 'Brand Bulk Add', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'deny', manager: 'allow', assistant: 'deny', sub_assistance: 'deny', sales_manager: 'deny', sales_man: 'deny' } },
        { moduleId: 'task_type_bulk_add', name: 'Task Type Bulk Add', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'deny', manager: 'allow', assistant: 'deny', sub_assistance: 'deny', sales_manager: 'deny', sales_man: 'deny' } },
        { moduleId: 'create_task', name: 'Create Task', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'allow', manager: 'allow', sbm: 'allow', rm: 'allow', am: 'allow', ar: 'allow', assistant: 'deny', sub_assistance: 'deny', sales_manager: 'allow', sales_man: 'allow', software_developer: 'allow', soft_ware_deloper: 'allow' } },
        { moduleId: 'assign_task', name: 'Assign Task', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'allow', manager: 'allow', sbm: 'allow', rm: 'allow', am: 'allow', ar: 'allow', assistant: 'deny', sub_assistance: 'deny', sales_manager: 'deny', sales_man: 'deny', software_developer: 'allow', soft_ware_deloper: 'allow' } },
        ...
        { moduleId: 'view_all_tasks', name: 'View All Tasks', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'allow', manager: 'allow', sbm: 'allow', rm: 'allow', am: 'allow', ar: 'allow', assistant: 'deny', sub_assistance: 'deny', sales_manager: 'deny', sales_man: 'deny', software_developer: 'allow', soft_ware_deloper: 'allow' } },
        { moduleId: 'view_assigned_tasks', name: 'View Assigned Tasks', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'allow', manager: 'allow', assistant: 'allow', sub_assistance: 'allow', sales_manager: 'deny', sales_man: 'deny', software_developer: 'allow', soft_ware_deloper: 'allow' } },
        { moduleId: 'team_page', name: 'Team', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'allow', manager: 'allow', sbm: 'allow', rm: 'allow', am: 'allow', assistant: 'deny', sub_assistance: 'deny', sales_manager: 'deny', sales_man: 'deny' } },
        { moduleId: 'reports_analytics', name: 'Reports / Analytics', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'deny', manager: 'team', assistant: 'deny', sub_assistance: 'deny', sales_manager: 'deny', sales_man: 'deny' } },
        { moduleId: 'access_management', name: 'Access Management', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'deny', manager: 'deny', assistant: 'deny', sub_assistance: 'deny', sales_manager: 'deny', sales_man: 'deny' } },
        { moduleId: 'profile_page', name: 'Profile', defaults: { super_admin: 'allow', admin: 'allow', md_manager: 'allow', ob_manager: 'allow', manager: 'allow', assistant: 'allow', sub_assistance: 'allow', sales_manager: 'allow', sales_man: 'allow', software_developer: 'allow', soft_ware_deloper: 'allow' } },
    ];
...
const requireModulePermission = (moduleId) => {
    return async (req, res, next) => {
        try {
            ...
            if ((role === 'sbm' || role === 'rm' || role === 'am' || role === 'ar' || role === 'troubleshoot_manager' || role === 'software_developer' || role === 'soft_ware_deloper') && (moduleId === 'create_task' || moduleId === 'assign_task')) {
                return next();
            }

            // Allow MD Manager access to access_management for MD Impex
            if (moduleId === 'access_management' && 
                (role === 'md_manager' || role === 'mdimpex_manager' || role === 'md_impex_manager')) {
                return next();
            }

            // Allow MD Impex users to create/assign tasks without explicit module defaults
            if ((moduleId === 'create_task' || moduleId === 'assign_task') &&
                (role === 'md_manager' || role === 'mdimpex_manager' || role === 'md_impex_manager' || companyKey === 'mdimpex' || companyKey === 'md_impex')) {
                return next();
            }
